...
public interface ICompanyService
{
    ...
    Task<Result<Company>> GetCompanyAsync(CompanyId id);
    Task<Result<Company>> GetCompanyBySlugAsync(string slug);
    Task<Result<Company>> CreateCompanyAsync(CreateCompany createCompany);
    Task<Result<Company>> UpdateCompanyAsync(CompanyId id, CreateCompany updateCompany);
    Task<Result<Company>> DeleteCompanyAsync(CompanyId id);
}
