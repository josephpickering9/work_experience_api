...
{
    public async Task<Result<IEnumerable<ProjectImage>>> GetProjectImagesAsync(Guid projectId)
    {
    ...
    public async Task<Result<ProjectImage>> GetProjectImageAsync(Guid projectId, Guid id)
    {
        var project = await context.Project.FindAsync(projectId);
    ...
    public async Task<Result<List<ProjectImage>>> SyncProjectImagesAsync(Guid projectId, List<CreateProjectImage> images)
    {
        var project = await context.Project.FindAsync(projectId);
